...
public class ChangeMode1 : MonoBehaviourPunCallbacks
{
    ...
    public void SelectAmount(int val)
    {
        amount.text = val.ToString();
        DataSaver1.Instance.BetAmount = val;
    }
    ...
    public void chooseValue(int val)
    {
        ...
        {
            photonView.RPC("PhotonPlate", RpcTarget.Others, val);
        }
        DataSaver1.Instance.coinValue = val;
    }
